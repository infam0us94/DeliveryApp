...
import com.project.deliveryapp.adapter.PlaceYourOrderAdapter;
...
public class PlaceYourOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.place_your_order_activity);
    ...
    private void onPlaceOrderButtonClick(RestaurantModel restaurantModel) {
        if (TextUtils.isEmpty(inputName.getText().toString())) {
            ...
            inputAddress.setError("Please enter inputAddress");
            return;
            ...
            return;
        } else if (isDeliveryOn && TextUtils.isEmpty(inputCardNumber.getText().toString())) {
            ...
            inputCardPin.setError("Please enter card pin");
            return;
        }
    ...
    private void initRecView(RestaurantModel restaurantModel) {
